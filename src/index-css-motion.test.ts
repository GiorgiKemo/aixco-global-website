...
describe("index.css motion rules", () => {
  ...
  it("registers the supplied AIXCO SVG icons for contact/social slots", () => {
    ...
    expect(desktopStoryHome).toContain("getWhatsAppContactForCountry(country)");
    expect(desktopStoryHome).toContain("whatsappContact={whatsappContact}");
  ...
  it("requests appropriately sized images for tall cropped story panels", () => {
