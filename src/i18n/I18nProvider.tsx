...
const REVERANCE_METADATA_DESCRIPTION = reveranceStockCopy.metadata;
...
const supplementalTranslations: Partial<Record<string, Partial<Record<CatalogLang, string>>>> = {
  ...
  "Please enter a valid phone number for the selected country.": {
    de: "Bitte geben Sie eine gültige Telefonnummer für das ausgewählte Land ein.",
    ru: "Введите действительный номер телефона для выбранной страны.",
    ka: "გთხოვთ, შეიყვანოთ არჩეული ქვეყნისთვის მოქმედი ტელეფონის ნომერი.",
    tr: "Lütfen seçilen ülke için geçerli bir telefon numarası girin.",
    ar: "يرجى إدخال رقم هاتف صالح للبلد المحدد.",
  },
  "Please check the form details and try again.": {
    de: "Bitte prüfen Sie die Angaben im Formular und versuchen Sie es erneut.",
    ru: "Проверьте данные формы и повторите попытку.",
    ka: "გთხოვთ, გადაამოწმოთ ფორმის მონაცემები და სცადოთ ხელახლა.",
    tr: "Lütfen form bilgilerini kontrol edip tekrar deneyin.",
    ar: "يرجى التحقق من بيانات النموذج والمحاولة مرة أخرى.",
  },
  "Too many requests were sent. Please wait a moment and try again.": {
    de: "Es wurden zu viele Anfragen gesendet. Bitte warten Sie einen Moment und versuchen Sie es erneut.",
    ru: "Отправлено слишком много запросов. Подождите немного и повторите попытку.",
    ka: "გაიგზავნა მეტისმეტად ბევრი მოთხოვნა. გთხოვთ, ცოტა ხანს დაელოდოთ და სცადოთ ხელახლა.",
    tr: "Çok fazla istek gönderildi. Lütfen biraz bekleyip tekrar deneyin.",
    ar: "تم إرسال عدد كبير جدًا من الطلبات. يرجى الانتظار قليلًا والمحاولة مرة أخرى.",
  },
  "The contact service is temporarily unavailable. Please try again shortly or email info@aixco.global.": {
    de: "Der Kontaktdienst ist vorübergehend nicht verfügbar. Bitte versuchen Sie es in Kürze erneut oder schreiben Sie an info@aixco.global.",
    ru: "Сервис связи временно недоступен. Повторите попытку позже или напишите на info@aixco.global.",
    ka: "საკონტაქტო სერვისი დროებით მიუწვდომელია. სცადეთ ცოტა მოგვიანებით ან მოგვწერეთ info@aixco.global-ზე.",
    tr: "İletişim hizmeti geçici olarak kullanılamıyor. Lütfen kısa süre sonra tekrar deneyin veya info@aixco.global adresine yazın.",
    ar: "خدمة التواصل غير متاحة مؤقتًا. يرجى المحاولة بعد قليل أو مراسلة info@aixco.global.",
  },
  "We could not reach the contact service. Check your connection and try again.": {
    de: "Der Kontaktdienst konnte nicht erreicht werden. Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
    ru: "Не удалось подключиться к сервису связи. Проверьте интернет-соединение и повторите попытку.",
    ka: "საკონტაქტო სერვისთან დაკავშირება ვერ მოხერხდა. შეამოწმეთ ინტერნეტი და სცადეთ ხელახლა.",
    tr: "İletişim hizmetine ulaşılamadı. Bağlantınızı kontrol edip tekrar deneyin.",
    ar: "تعذر الوصول إلى خدمة التواصل. تحقق من اتصالك وحاول مرة أخرى.",
  },
  "Emerging market opportunities with AIXCO": {
    de: "Zugang zu aufstrebenden Märkten mit AIXCO",
    ru: "Возможности на развивающихся рынках с AIXCO",
