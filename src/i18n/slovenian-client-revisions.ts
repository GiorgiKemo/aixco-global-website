...
export const slovenianClientRevisions = {
  ...
  "Explore selected real estate opportunities with transparent euro pricing from EUR 45,000, brokerage, and property administration through AIXCO.": {
    sl: "Odkrijte izbrane nepremičninske priložnosti s pregledno oblikovanimi cenami v evrih že od 45.000 EUR, posredovanjem in upravljanjem nepremičnin prek podjetja AIXCO.",
  },
  ...
  "USD 800m+ development volume": { sl: "USD 800 m+ vrednost razvojnega obsega projektov" },
  ...
  "Selected emerging-market projects and apartments through AIXCO, with Batumi as the current focus, entry from €45,000, 100% foreign ownership, bank financing minimum 60%, and a transparent ISO-certified process.": {
    sl: "Izbrani projekti in stanovanja na razvijajočih se trgih prek podjetja AIXCO, s Batumijem kot trenutnim fokusom, vstopom že od 45.000 EUR, 100-odstotnim tujim lastništvom, bančnim financiranjem najmanj 60 % in preglednim, ISO-certificiranim postopkom.",
  },
  "€5k": { sl: "5.000 EUR" },
  "Secure your position from €5,000": { sl: "Zavarujte si mesto že od 5.000 EUR" },
  "€45k": { sl: "45.000 EUR" },
  "Entry from €45,000": { sl: "Vstop že od 45.000 EUR" },
  "60%+": { sl: "60 %+" },
  ...
  "The minimum investment amount is €5,000.": {
    sl: "Minimalni znesek naložbe je 5.000 EUR.",
  },
