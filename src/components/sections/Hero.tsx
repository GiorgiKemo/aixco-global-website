  ...
  return (
    <section className="hero-reference-font relative isolate min-h-[100svh] overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col items-center px-6 pt-[45vh] text-center md:pt-[48vh]">
        <motion.h1
          className="hero-reference-font max-w-[82rem] text-4xl font-semibold leading-[1.04] tracking-normal text-white drop-shadow-[0_8px_28px_rgb(0_0_0/0.46)] [perspective:900px] sm:text-5xl md:text-6xl lg:text-[5rem]"
          initial="hidden"
        ...
        <motion.p
          className="hero-reference-font mt-7 max-w-2xl text-base leading-relaxed text-white/85 drop-shadow-[0_3px_18px_rgb(0_0_0/0.42)] md:text-lg"
