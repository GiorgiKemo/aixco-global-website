      ...
      <main>
        <section className={styles.hero} aria-labelledby="private-client-title">
          ...
          <div className={styles.heroMedia}>
            <Image src={heroImage} alt={content.hero.imageAlt} fill priority sizes="(max-width: 800px) 100vw, 58vw" quality={90} />
        ...
        <section id="markets" className={styles.marketSection}>
          <div className={styles.marketMedia}><Image src={contextImage} alt={content.markets.imageAlt} fill sizes="(max-width: 800px) 100vw, 50vw" quality={88} /></div>
        ...
        <section id="contact" className={styles.contactSection}>
          <div className={styles.contactMedia}><Image src={heroImage} alt="Batumi coastline at dusk" fill sizes="(max-width: 800px) 100vw, 42vw" quality={86} /></div>
