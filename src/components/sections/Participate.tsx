...
function ParticipationRouteCard({
  ...
  const useViewportLayout = route.id === "apartment";
  ...
  const viewportCardClass = useViewportLayout ? "md:h-[calc(100svh-5rem)] md:max-h-[calc(100svh-5rem)] lg:h-[calc(100svh-5rem)] lg:max-h-[calc(100svh-5rem)]" : "";
  ...
  return (
    ...
    >
      <div
        ...
        className={`relative min-h-[22rem] overflow-hidden bg-foreground md:col-span-5 md:min-h-0 md:self-stretch lg:col-span-5 lg:min-h-0 lg:self-stretch ${mediaOrderClass}`}
      >
        <LiveVideo
      ...
      <div
        ...
        className={`flex min-h-0 flex-col border-foreground/5 p-7 md:col-span-7 lg:col-span-7 ${copyLayoutClass} ${copyOrderClass} ${
