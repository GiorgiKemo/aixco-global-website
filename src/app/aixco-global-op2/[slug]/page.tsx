      ...
      <section className="property-hero relative mx-auto grid max-w-[96rem] overflow-hidden border-b border-[#9E9D9D]/35 lg:min-h-[40rem] lg:grid-cols-[minmax(0,1.16fr)_minmax(28rem,0.84fr)]">
        <div className="property-hero__content order-2 flex flex-col justify-center bg-[#F3EDE1] px-5 py-10 sm:px-8 sm:py-12 lg:order-1 lg:px-[clamp(3rem,4.2vw,4.5rem)] lg:py-10">
          ...
          <div className={`mt-6 grid gap-3 ${property.id === "current-project" ? "sm:grid-cols-3" : "sm:grid-cols-2"}`}>
            <PropertyContactLink className="inline-flex min-h-12 items-center justify-center gap-2 whitespace-normal border border-[#9E9D9D] bg-transparent px-3 text-center text-xs font-semibold uppercase tracking-[0.12em] text-[#161616] transition-colors hover:border-[#161616] hover:bg-[#161616] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E6C767]">
              <Tx>Contact AIXCO</Tx>
            </PropertyContactLink>
            {property.id === "current-project" ? (
              <>
                <CurrentProjectBrochureLink
                  className="inline-flex min-h-12 items-center justify-center gap-2 whitespace-normal bg-[#161616] px-3 text-center text-xs font-semibold uppercase tracking-[0.12em] text-white transition-colors hover:bg-[#9A7425] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E6C767]"
                />
